        ...
        <section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
            ...
            <a href="https://wa.me/5511999999999" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
              <div style={{ background: '#fff', border: '1px solid #e8e8ec', borderRadius: '14px', padding: '18px', height: '100%', boxSizing: 'border-box', cursor: 'pointer', transition: 'border-color .15s, box-shadow .15s' }}
                onMouseEnter={e => { const d = e.currentTarget as HTMLDivElement; d.style.borderColor = '#25D366'; d.style.boxShadow = '0 4px 16px rgba(37,211,102,0.12)' }}
                onMouseLeave={e => { const d = e.currentTarget as HTMLDivElement; d.style.borderColor = '#e8e8ec'; d.style.boxShadow = 'none' }}
              >
                <div style={{ width: 36, height: 36, borderRadius: '10px', background: '#f0fdf4', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '12px' }}>
                ...
                <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '11px', color: '#9ca3af', margin: '0 0 10px' }}>Tire dúvidas pelo WhatsApp</p>
            ...
            <a href="mailto:suporte@encantivapro.com.br" style={{ textDecoration: 'none' }}>
              <div style={{ background: '#fff', border: '1px solid #e8e8ec', borderRadius: '14px', padding: '18px', height: '100%', boxSizing: 'border-box', cursor: 'pointer', transition: 'border-color .15s, box-shadow .15s' }}
                onMouseEnter={e => { const d = e.currentTarget as HTMLDivElement; d.style.borderColor = '#ff33cc'; d.style.boxShadow = '0 4px 16px rgba(255,51,204,0.1)' }}
                onMouseLeave={e => { const d = e.currentTarget as HTMLDivElement; d.style.borderColor = '#e8e8ec'; d.style.boxShadow = 'none' }}
              >
                <div style={{ width: 36, height: 36, borderRadius: '10px', background: '#fff0fb', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '12px' }}>
                ...
                <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '11px', color: '#9ca3af', margin: '0 0 10px' }}>suporte@encantivapro.com.br</p>
        ...
        <section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px' }}>
            ...
            <a href="https://chat.whatsapp.com/LRqQ4Gnlw0740Zup1aPLQh" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
              <div style={{ background: '#fff', border: '1px solid #e8e8ec', borderRadius: '14px', padding: '16px', height: '100%', boxSizing: 'border-box', cursor: 'pointer', transition: 'border-color .15s, box-shadow .15s' }}
                onMouseEnter={e => { const d = e.currentTarget as HTMLDivElement; d.style.borderColor = '#25D366'; d.style.boxShadow = '0 4px 12px rgba(37,211,102,0.1)' }}
                onMouseLeave={e => { const d = e.currentTarget as HTMLDivElement; d.style.borderColor = '#e8e8ec'; d.style.boxShadow = 'none' }}
              >
            ...
            <a href="https://instagram.com/encantivapro" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
              <div style={{ background: '#fff', border: '1px solid #e8e8ec', borderRadius: '14px', padding: '16px', height: '100%', boxSizing: 'border-box', cursor: 'pointer', transition: 'border-color .15s, box-shadow .15s' }}
                onMouseEnter={e => { const d = e.currentTarget as HTMLDivElement; d.style.borderColor = '#E1306C'; d.style.boxShadow = '0 4px 12px rgba(225,48,108,0.1)' }}
                onMouseLeave={e => { const d = e.currentTarget as HTMLDivElement; d.style.borderColor = '#e8e8ec'; d.style.boxShadow = 'none' }}
              >
