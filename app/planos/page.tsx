      ...
      <div style={{ display: 'flex', gap: '24px', justifyContent: 'center', flexWrap: 'wrap', maxWidth: '1100px', margin: '0 auto 40px' }}>
        {PLANOS.map(plano => (
          <div key={plano.id} style={{
            ...
            background: plano.destaque ? 'linear-gradient(160deg, rgba(255,51,204,0.12), rgba(153,0,255,0.12))' : 'rgba(255,255,255,0.04)',
            border: plano.destaque ? '1.5px solid rgba(255,51,204,0.4)' : '1px solid rgba(255,255,255,0.1)',
            borderRadius: '24px', padding: '36px', position: 'relative',
            boxShadow: plano.destaque ? '0 24px 80px rgba(255,51,204,0.15)' : 'none',
          }}>
            {plano.destaque && (
              <div style={{
            ...
            <p style={{ fontFamily: 'Inter, sans-serif', fontWeight: 700, fontSize: '13px', color: '#ffffff55', letterSpacing: '2px', textTransform: 'uppercase', margin: '0 0 8px 0' }}>
              {plano.nome}
            </p>
            ...
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '13px', color: plano.destaque ? '#ff33cc' : '#ffffff44', margin: '0 0 24px 0' }}>
              {plano.descricao}
            </p>
              ...
              {plano.beneficios.map((b, i) => (
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <div style={{
                    ...
                    background: plano.destaque ? 'linear-gradient(135deg, #ff33cc, #9900ff)' : 'rgba(255,255,255,0.1)',
