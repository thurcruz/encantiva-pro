        ...
        <>
          ...
          <div style={{ ...card, display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <button
              ...
              style={{ alignSelf: 'flex-start', display: 'flex', alignItems: 'center', gap: '6px', background: comMargem ? '#fff0fb' : '#fafafa', border: `1.5px solid ${comMargem ? '#ff33cc' : '#e8e8ec'}`, borderRadius: '999px', padding: '7px 12px', color: comMargem ? '#ff33cc' : '#9ca3af', fontFamily: 'Inter, sans-serif', fontWeight: 700, fontSize: '11px', cursor: 'pointer', transition: 'all .15s' }}
            >
