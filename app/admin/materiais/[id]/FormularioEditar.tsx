    ...
    <form onSubmit={handleSubmit}>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 320px', gap: '24px', alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div style={cardStyle}>
            <h2 style={{ fontFamily: 'Inter, sans-serif', fontWeight: 700, fontSize: '15px', color: '#fff', margin: '0 0 20px 0' }}>Informações básicas</h2>
          ...
          <div style={cardStyle}>
            <h2 style={{ fontFamily: 'Inter, sans-serif', fontWeight: 700, fontSize: '15px', color: '#fff', margin: '0 0 20px 0' }}>Categorização</h2>
          ...
          <div style={cardStyle}>
            <h2 style={{ fontFamily: 'Inter, sans-serif', fontWeight: 700, fontSize: '15px', color: '#fff', margin: '0 0 8px 0' }}>Arquivo para download</h2>
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '13px', color: '#ffffff44', margin: '0 0 16px 0' }}>Deixe em branco para manter o arquivo atual</p>
            <div style={{ background: arquivo ? '#ff33cc08' : '#ffffff05', border: `2px dashed ${arquivo ? '#ff33cc55' : '#ffffff18'}`, borderRadius: '12px', padding: '24px', textAlign: 'center', cursor: 'pointer', position: 'relative' }}>
              <input type="file" onChange={e => setArquivo(e.target.files?.[0] ?? null)} accept=".pdf,.zip,.png,.jpg,.jpeg"
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          <div style={cardStyle}>
            <h2 style={{ fontFamily: 'Inter, sans-serif', fontWeight: 700, fontSize: '15px', color: '#fff', margin: '0 0 16px 0' }}>Imagem de preview</h2>
            <div style={{ aspectRatio: '1', borderRadius: '12px', overflow: 'hidden', marginBottom: '16px', background: 'linear-gradient(135deg, #9900ff22, #ff33cc11)', border: '1px solid #ffffff12', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
              {previewUrl ? (
          ...
          <div style={cardStyle}>
            {erro && (
              <div style={{ background: '#ff33cc11', border: '1px solid #ff33cc44', borderRadius: '10px', padding: '12px 16px', color: '#ff33cc', fontFamily: 'Inter, sans-serif', fontSize: '14px', marginBottom: '16px' }}>
                {erro}
              </div>
            )}
            {sucesso && (
              <div style={{ background: '#00ff8811', border: '1px solid #00ff8844', borderRadius: '10px', padding: '12px 16px', color: '#00ff88', fontFamily: 'Inter, sans-serif', fontSize: '14px', marginBottom: '16px', textAlign: 'center', fontWeight: 600 }}>
                ✓ Salvo com sucesso!
              </div>
            )}
