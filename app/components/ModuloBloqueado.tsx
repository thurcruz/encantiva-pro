...
export default function ModuloBloqueado({ titulo, descricao, planoMinimo, icone }: Props) {
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f9f9f9' }}>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '32px 40px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '60px 24px', textAlign: 'center' }}>
          ...
          <h2 style={{ fontFamily: 'Inter, sans-serif', fontWeight: 900, fontSize: '28px', color: '#140033', letterSpacing: '-1px', margin: '0 0 12px 0' }}>
            {titulo} é premium
          </h2>
          <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '16px', color: '#00000066', margin: '0 0 40px 0', maxWidth: '500px', lineHeight: 1.7 }}>
          ...
          <div style={{ background: '#fff', border: '1px solid #eeeeee', borderRadius: '16px', padding: '28px', marginBottom: '32px', maxWidth: '400px', width: '100%', textAlign: 'left' }}>
            <p style={{ fontFamily: 'Inter, sans-serif', fontSize: '12px', fontWeight: 700, color: '#00000033', letterSpacing: '1.5px', textTransform: 'uppercase' as const, margin: '0 0 16px 0' }}>
